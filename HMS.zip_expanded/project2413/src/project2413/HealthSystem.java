...
public class HealthSystem{
	...
	public boolean addResult(Exam result) {
		...
		this.runQuery("INSERT INTO Exam_Results VALUES(" + this.examID + ", " + this.current.getID() + ", " + result.getID() + ", " + result.getDate() + ", " + result.getStatus() + ");", false);
		//this.results.add(result);
	...
	public boolean signOut(User u, Loader l, HealthSystem hs, Monitor mon) {
		//write data here
		//clear db and stuff
		l.saveVars(hs.examID, mon.getAlertID(), mon.getActivityID(), u.getID(), u.getUsername(), u.getPassword());
		this.isAuthenticated = false;
		return true;
	}
